...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <article className="">
        <h4 className="font-medium text-2xl text-center">Olá, meu nome é David</h4>
      ...
      <div className="w-full h-26  mt-16 rounded-md max-w-4xl flex justify-center" role="list">
        {techList.map((tech) => (
          <div
            key={tech.id}
